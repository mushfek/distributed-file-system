...
public class ServerNode  {
    ...
    public static HashMap<String,Socket> serverSocketMap = new HashMap<>();
    public static HashMap<Socket,BufferedReader> serverReaders = new HashMap<>();
    public static HashMap<Socket,PrintWriter> serverWriters = new HashMap<>();
    
	// Hashmaps used to store Client sockets, read and write buffers
    public static HashMap<String,Socket> clientSocketMap = new HashMap<>();
    public static HashMap<Socket,BufferedReader> clientReaders = new HashMap<>();
    public static HashMap<Socket,PrintWriter> clientWriters = new HashMap<>();
